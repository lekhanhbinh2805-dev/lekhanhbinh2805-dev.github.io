// 1. Cấu hình chung
const SCRIPT_URL = 'https://script.google.com/macros/s/AKfycbwsTISnfFAECWEv-dCLOqOOrbVJTNY3cws_AqrRmiOYTophvmS5fZedbt46WnPImEM5zA/exec';
...
Tổng (Đạt + Không đạt) đang là ${dat + loi}, không bằng Số lượng lấy mẫu ${tong}.`);
        return;
    }
        }
